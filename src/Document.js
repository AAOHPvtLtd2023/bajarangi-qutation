...
Font.register({
  family: "Roboto",
  fonts: [{ src: AlgerianFont, fontStyle: "italic", fontWeight: "bold" }],
});

Font.register({
  family: "Roboto1",
  fonts: [{ src: AlgerianFont1, fontWeight: "bold" }],
});

Font.register({
  family: "Roboto2",
  fonts: [{ src: AlgerianFont2, fontWeight: "bold" }],
});

Font.register({
  family: "Roboto3",
  fonts: [{ src: AlgerianFont3, fontWeight: "bold" }],
});
